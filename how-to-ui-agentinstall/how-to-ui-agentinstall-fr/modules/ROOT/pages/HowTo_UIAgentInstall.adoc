...
supprime l’ancien service de l’Agent. Notez que cela ne fonctionnera que si a) le service de l’Agent a été installé à l’aide de son nom de service par défaut et b) si _uninstall.properties_ du programme d'installation de la console contient les valeurs correctes pour désinstaller l'agent.
